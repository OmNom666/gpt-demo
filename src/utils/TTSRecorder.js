...
//通过 https://console.xfyun.cn/app/create 创建应用后获取APPID、API_SECRET、API_KEY
const APPID = '19ec4b15'
const API_SECRET = 'ZGRhMGMxNTE1NTJmY2Y5OTBjODhkNmFl'
const API_KEY = 'e54b42551af3ca583ef1e0ab48516af0'
let total_res = "";
